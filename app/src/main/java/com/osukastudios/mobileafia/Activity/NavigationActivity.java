...
import com.osukastudios.mobileafia.Adapter.ViewPagerAdapter;
...
public class NavigationActivity extends AppCompatActivity {
    ...
    public void setDotIndicator(int position) {
        ...
        dots[position].setTextColor(getResources().getColor(R.color.equity, getApplicationContext().getTheme()));
    }
